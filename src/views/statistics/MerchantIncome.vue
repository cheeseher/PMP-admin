  ...
  <div class="merchant-income-container">
    ...
    <div class="text-stats-bar">
      <div class="stat-item">
        ...
        <span class="value emphasis">{{ formatAmount(totalSupplementAmount) }}</span>
      </div>
      <div class="stat-item">
        <span class="label">总成功收款金额：</span>
        <span class="value income">{{ formatAmount(totalAmount) }}</span>
      </div>
      <div class="stat-item">
      ...
      <div class="stat-item">
        <span class="label">总入账金额：</span>
        <span class="value income">{{ formatAmount(totalAfterTaxAmount) }}</span>
      </div>
      <div class="stat-item">
